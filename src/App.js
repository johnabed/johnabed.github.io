...
function App() {
  return (
    <div class="card middle" id="drag">
      <div class="top-section">
        <div class="menuicon" id="dragheader">
          <span class="s1"></span>
          <span class="s2"></span>
        </div>
      ...
      <div class="info-section">
        ...
        <div class="s-m">
          <span>
            {" "}
            <span class="fas fa-map-marker-alt"></span> Toronto, Ontario, Canada{" "}
          </span>
        </div>
        <h2>
          education
        ...
        <p>
          B.A. Honours Business Administration & B.Sc. Honours Computer Science.
        </p>
        <h2>
          connect
          <div class="border"></div>
